    ...
    >
      <div className="relative w-full">
        <a href={linkedin} target="_blank">
          <div className="w-full h-full bg-gradient-to-br from-[#DD7600] to-[#51A2FF] absolute hover:opacity-[20%] opacity-[0] hover:cursor-pointer duration-300 transition-ease-in-out"></div>
        </a>
        <Image
          src={img}
          alt={name}
